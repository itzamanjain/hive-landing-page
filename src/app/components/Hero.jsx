        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {navigation.map((item, index) => (
              <Link key={index} href={item.path} className="text-gray-500 hover:text-yellow-600 text-lg">
                {item.title}
              </Link>
            ))}
          </div>
          ...
          <button className="lg:hidden text-gray-500 focus:outline-none" onClick={() => setIsMenuOpen(!isMenuOpen)}>
            {isMenuOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
          </button>
        </div>
        {isMenuOpen && (
          <div className="lg:hidden mt-4 bg-black rounded-lg shadow-lg p-4">
            {navigation.map((item, index) => (
              <Link key={index} href={item.path} className="block py-2 text-gray-500 hover:text-yellow-600 text-lg">
                {item.title}
              </Link>
            ))}
            <button className="mt-4 w-full inline-flex h-12 items-center justify-center font-geist rounded-3xl border border-gray-800 bg-white px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50">
              Get Started
            </button>
          </div>
        )}
        ...
        <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex">
          <div className="flex-none space-y-5 max-w-xl">
            ...
            <p className="font-geist text-lg">
              Empowering job seekers with personalized guidance, essential resources, and a supportive community for
              success.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="inline-flex h-12 items-center justify-center font-geist rounded-3xl border border-gray-800 bg-gradient-to-t bg-white px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50">
                Get Started
