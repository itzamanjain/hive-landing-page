...
export default function Testimonial() {
  ...
  return (
    <section className="relative py-14">
      <div className="absolute inset-0 bg-black bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
        ...
        <div className="mt-12">
          <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li key={idx} className="bg-transparent bg-glass-gradient rounded-xl border shadow-md">
                <div className="p-4">
                  <svg
                ...
                <figure>
                  <blockquote>
                    <p className="text-gray-500 tracking-tighter font-geist text-base sm:text-lg font-normal px-4 py-1">
                      {item.quote}
                    </p>
                  </blockquote>
                  <div className="flex items-center gap-x-4 p-4 mt-6 bg-page-gradient">
                    ...
                    />
                    <div>
                      <span className="block text-gray-500 font-semibold text-sm sm:text-base">{item.name}</span>
